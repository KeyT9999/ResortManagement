...
public class ContractService implements IContactService {
    ...
    public void addContract() {
        ...
        try {
            ...
            String bookingID;
            do {
                bookingID = Validation.validateID("Booking ID", "Invalid ID, try again", "^BK\\d{3}$");
            ...
            int contractNum;
            do {
                contractNum = Validation.validateInteger("Contract Number", "Invalid number, try again", 0);
            ...
            double totalAmount;
            do {
                depositAmount = Validation.validateDouble("Deposit Amount", "Invalid amount, try again", 0);
    ...
    public void update(Contract c) {
        try {
            ...
            while (isUpdate) {
                ...
                int choice = Validation.validateInteger("Enter Your Choice", errMsg, 1);
                ...
                try {
                    switch (choice) {
                        ...
                        case 2 -> {
                            String bookingID = Validation.validateID("Booking ID", "Invalid ID, try again", "^BK\\d{3}$");
                            selectedField.set(c, bookingID);
                        }
                        case 3 -> {
                            double depositAmount = Validation.validateDouble("Deposit Amount", "Invalid amount, try again", 1);
                            selectedField.set(c, depositAmount);
                        }
                        case 4 -> {
                            double totalAmount = Validation.validateDouble("Total Amount", errMsg, 1);
