...
public class PromotionService implements IPromotionService {
    ...
    public void inputVoucher() {
        int v10 = Validation.validateInteger("Enter Number Of 10% Voucher", errMsg, 0);
        int v20 = Validation.validateInteger("Enter Number Of 20% Voucher", errMsg, 0);
        int v50 = Validation.validateInteger("Enter Number Of 50% Voucher", errMsg, 0);
